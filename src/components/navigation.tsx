...
export default function Navigation() {
    ...
    return (
        <>
            <div className="flex flex-row h-20 bg-slate-900 sticky top-0">
                ...
                <div className="flex flex-row basis-1/4 justify-end items-center lg:mr-10 mr-4 md:space-x-4 space-x-1">
                    <Link
                        href="/signup"
                        className="flex items-center justify-center rounded-lg lg:w-1/4 md:w-4/5 h-12 md:p-2 px-2 my-2 bg-left bg-slate-900 text-slate-200 font-bold lg:text-lg md:text-sm text-xs hover:bg-slate-200 hover:text-slate-900 duration-700"
                    >
                        Sign up
                    </Link>
                    <Link
                        href="/signin"
                        className="flex items-center justify-center rounded-lg lg:w-1/4 md:w-4/5 h-12 md:p-2 px-2 my-2 bg-slate-900 text-slate-200 font-bold lg:text-lg md:text-sm text-xs hover:bg-slate-200 hover:text-slate-900 duration-700"
                    >
                        Sign in
                    </Link>
                </div>
