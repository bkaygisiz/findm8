...
export default function SignUpForm() {
    ...
    return (
        <>
            <main className="bg-gradient-to-r from-gray-900 to-slate-800 h-screen flex justify-center items-center text-slate-300">
                <form className="flex flex-col w-2/5 py-10 h-auto justify-center items-center animate-fadin shadow-slate-900 shadow-2xl rounded-lg ring-2 ring-slate-800 bg-gradient-to-r from-slate-800 to-gray-900 space-y-8">
                    ...
                    <div className='w-4/6 flex flex-col items-center'>
                        ...
                        <input
                            ...
                            placeholder='Email'
                            className="bg-slate-900 w-4/5 p-1 ring-1 ring-slate-800 rounded shadow-md hover:bg-slate-800 duration-300 focus:outline-none"
                        />
                    ...
                    <div className='w-4/6 flex flex-col items-center'>
                        <button
                            onClick={signUp}
                            className="bg-slate-900 w-1/5 break-words p-1 rounded border-solid border border-slate-700 shadow-md hover:bg-slate-800 duration-300 active:bg-slate-900 active:ring-2 active:ring-green-700 focus:outline-none"
                        >
